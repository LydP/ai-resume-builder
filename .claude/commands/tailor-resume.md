...
Read `config.json` field `resume_format` (default: `"formats/sheets-resume.md"`) and load that file. Follow the markdown template and all structural rules defined there exactly.
